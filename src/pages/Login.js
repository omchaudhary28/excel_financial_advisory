  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        console.log(err); // Added for debugging on mobile
        ...
        <div className="bg-background-light dark:bg-background-dark rounded-2xl shadow-2xl dark:shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
          ...
          <div className="px-8 pt-8 pb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="text-right text-sm mt-2 mb-4" style={{ display: 'block' }}>
                <Link to="/forgot-password" className="font-semibold text-primary hover:text-primary-dark transition-colors duration-300" style={{ textDecoration: 'underline' }}>
                  Forgot Password?
                </Link>
              </div>
